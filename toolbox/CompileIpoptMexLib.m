...
elseif isunix
  ...
  CMD = [ CMD ...
    ...
    'LINKLIBS=''-Lbin/linux -L$MATLABROOT/bin/$ARCH -Wl,-rpath,$MATLABROOT/bin/$ARCH -lipopt -lcoinmumps -lgfortran -lopenblas -lgomp -ldl -lMatlabDataArray -lmx -lmex -lmat -lm '' ' ...
  ];
elseif ispc
